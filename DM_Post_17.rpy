...
## Este archivo corresponde al Post #17 del hilo "Programando Juegos VN con Ren'Py!", en la
## que se introducen modificaciones al código del Post #16.
...
## Si quieres colocar el archivo en tu proyecto, este te dará problemas con el "label start".
## Toma medidas preventivas antes de añadir este archivo a tu proyecto.
