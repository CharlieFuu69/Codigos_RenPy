...
label start:
    ...
    # En sintaxis de Ren'Py, se mostrará un texto que señale que se está conectando al server
    ...
    python:
        try:
            ...
            data.encoding = "utf-8" # Codificación comi UTF-8

            lectura = json.loads(data.text) # Decodificación del JSON
            text_output = lectura["texto_mamadisimo"] # Extracción del texto final mediante la palabra clave
